...
export const researchSkills: SkillDef[] = [
  {
    name: 'analyze',
    category: 'research',
    description: 'Deep token and project due diligence — risk score, rug probability, strengths, red flags, recommendation.',
    priceUSD: 0.35,
  ...
  },
  {
    ...
    category: 'research',
    description: 'Token supply, inflation, unlock cliff analysis — sustainability score and sell pressure outlook.',
    priceUSD: 0.50,
  ...
  },
  {
    name: 'vc-tracker',
    category: 'research',
    description: 'VC investment activity and thesis — hot sectors, who is backing what, signals for builders and traders.',
    priceUSD: 1.00,
    endpoint: 'vc-tracker',
    inputSchema: {
      type: 'object',
  ...
  },
  {
    name: 'advisor',
    category: 'research',
    description: 'Full token launch playbook — tokenomics, 8-week timeline, marketing strategy, community growth, KPIs.',
    priceUSD: 3.00,
    ...
    inputSchema: {
      ...
      properties: {
        ...
        targetAudience: { type: 'string', description: 'Target audience (optional)' },
        budget: { type: 'string', description: 'Launch budget (optional)' },
      },
      required: ['description'],
    },
    buildBody: ({ description, projectName, targetAudience, budget }) => ({
      description,
  ...
  },
  {
    name: 'grant',
    category: 'research',
    description: 'Base ecosystem grant scoring — overall score, Fund/Decline recommendation, suggested grant size.',
    priceUSD: 5.00,
    ...
    inputSchema: {
      ...
      properties: {
        ...
        teamBackground: { type: 'string', description: 'Team experience (optional)' },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        currentModel: { type: 'string', description: 'Current monetization model (optional)' },
      },
    },
  ...
  },
  {
    ...
    category: 'research',
    description: 'Pre-deployment security check for Base contracts — vulnerabilities, centralization risks, go/no-go verdict.',
    priceUSD: 0.50,
    ...
    inputSchema: {
      ...
      properties: {
        ...
        description: { type: 'string', description: 'Contract description (optional)' },
        projectName: { type: 'string', description: 'Project name (optional)' },
      },
    },
